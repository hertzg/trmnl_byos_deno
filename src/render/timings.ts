...
// Collects per-step wall-clock from arbitrarily deep call sites without
// threading a recorder argument through every signature or changing return
// types.
//
...
// Outside a collector, `timed` is a pass-through — callers that don't care
// about timings (e.g. hot production paths) pay nothing.
