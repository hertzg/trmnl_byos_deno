...
every run and never stored. It is the **Device**'s default quiet-state display: a composing
**Super-Plugin** shows the Gallery whenever **Transport** is schedule-quiet
